...
-   დავამატე role column database ში და შემდეგ გავუწერე შესაბამისი ლოგიკა User ში და ხელმისაწვდომი გავხადე AppServiceProvider ში რომ შეამოწმოს admin არის თუ არა 
- თუ შევედი ჯერ admin სივრცეში და მერე გავუწერე რომ არავისთვის იყოს ხელმისაწვდომი მაინც იქ გავჩერდები და არ გამომაგდებს. ამისთვის საჭიროა შესაბამისი კოდის გაწერა: 
route::get('/admin', function () {
    return 'Private admin only area';
})->can('view-admin'); can ის გაწერით
- appServiceProvider ში გავუწერე რომ თუ id 1 მაშინ admin ხელმისაწვდომი იყოს, სხვა შემთხვევაში არა 
...
- Gate გამოიყენება ზოგადი უფლებებისთვის.
- Policy გამოიყენება, როცა უფლება კონკრეტულ მოდელზეა დამოკიდებული.
- გინდა რომ იდეის რედაქტირება მხოლოდ მისმა ავტორმა შეძლოს . აქ უკვე საჭიროა არა მარტო User, არამედ კონკრეტული Idea-ც.
...
- პრობლემა არის ის რომ ეხლა url ში თუ შევუცვლი index ამ შემთხვევაში წვდომა მაქვს სხვების მიერ დაწერილ ideas ზეც , მათ შორის მათი შეცვლაც შემიძლია და ეს უნდა გამოვასწოროთ policy საშუალებით.
